...
import { UserEntityHistorySubscriptionJson } from './__json__/user-entity-history-subscription-json';
import { UserEntityHistorySubscription } from './user-entity-history-subscription';
import { UserEntityHistorySubscriptionCreateRequest } from './user-entity-history-subscription-create-request';
import { UserEntityHistorySubscriptionDeleteRequest } from './user-entity-history-subscription-delete-request';
...
import { BaJobJson } from '../vac/__json__/ba-job';
import { BaJob } from '../vac/ba-job';
...
export class User {
   ...
   */
  /* istanbul ignore next: autogenerated */
  async getVacJobs(companyId: string, locationId?: string): Promise<Array<BaJob>> {
    return Iland.getHttp()
   ...
   */
  /* istanbul ignore next: autogenerated */
  async getEntityHistorySubscriptions(): Promise<Array<UserEntityHistorySubscription>> {
    return Iland.getHttp().get(`/users/${this.username}/entity-history-subscriptions`).then((response) => {
      const json = response.data.data as Array<UserEntityHistorySubscriptionJson>;
      return json.map((it) => new UserEntityHistorySubscription(it));
    });
  }
   ...
   */
  /* istanbul ignore next: autogenerated */
  async subscribeToEntityHistory(request: UserEntityHistorySubscriptionCreateRequest):
      Promise<UserEntityHistorySubscription> {
    return Iland.getHttp().post(`/users/${this.username}/actions/subscribe-to-entity-history`, request.json)
        .then((response) => {
          const json = response.data as UserEntityHistorySubscriptionJson;
          return new UserEntityHistorySubscription(json);
        });
  }
   ...
   */
  /* istanbul ignore next: autogenerated */
  async removeEntityHistorySubscription(request: UserEntityHistorySubscriptionDeleteRequest): Promise<unknown> {
    return Iland.getHttp().post(`/users/${this.username}/actions/unsubscribe-from-entity-history`, request.json);
  }
   ...
   * @returns {string} Return the entity prefix of the entity object
   */
  /* istanbul ignore next: autogenerated */
  private getEntityPrefixFor(entityUuid: any): string {
    const prefix = entityUuid.split(':')[3];
    switch (prefix) {
      case 'gateway':
        return 'edge';
      default:
  ...
  /**
   * Get all user resource alerts for the specified entity.
   * @returns {Promise<any>}
   */
  /* istanbul ignore next: autogenerated */
  async getResourceAlerts(entityUuid: any): Promise<any> {
    const entityPrefix = this.getEntityPrefixFor(entityUuid);
    return Iland.getHttp().get(`/users/${this.username}/alerts/resource/${entityPrefix}/${entityUuid}`)
  ...
  /**
   * Update user resource alert for the specified entity.
   * @returns {Promise<any>}
   */
  /* istanbul ignore next: autogenerated */
  async updateResourceAlerts(entityUuid: any, alerts: any): Promise<any> {
    const entityPrefix = this.getEntityPrefixFor(entityUuid);
    return Iland.getHttp().put(`/users/${this.username}/alerts/resource/${entityPrefix}/${entityUuid}`, alerts)
        .then(function(result) {
          return (result.data as any).data;
        });
  }
